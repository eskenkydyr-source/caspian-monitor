...
Государственный экологический мониторинг казахстанского сектора Каспийского моря ведёт
РГП «Казгидромет». Отбор проб морской воды выполняется на 50 прибрежных пунктах — 22 в
Атырауской и 28 в Мангистауской области; качество воды определяется по 37 показателям,
мониторинг донных отложений проводится два раза в год, весной и осенью. Сводные сведения
публикуются в ежемесячном информационном бюллетене о состоянии окружающей среды,
показатели на интерактивной карте обновляются раз в месяц.

Это дискретные наблюдения. Между отборами проб состояние акватории не фиксируется, а
результаты становятся доступны с задержкой до месяца. При аварийном розливе нефтепродуктов
такой цикл означает, что загрязнение обнаруживают уже после того, как пятно
распространилось: 30 марта 2024 года разлив у месторождения Кашаган зафиксировал радарный
снимок спутника Sentinel-1A, когда пятно достигло площади около 7 км².

Caspian Monitor не заменяет государственную сеть наблюдений, а дополняет её непрерывным
автоматическим измерением. Сеть автономных буёв круглосуточно измеряет показатели качества
морской воды и передаёт их по энергоэффективному радиоканалу LoRaWAN. Сервер декодирует
телеметрию, накапливает ряды наблюдений, автоматически сравнивает значения с нормативными
порогами и формирует события при их нарушении. Оператор видит обстановку по всей акватории
на одной панели, а накопленные данные доступны любому пользователю в машиночитаемом виде
без регистрации.

---

## 1.1. Состав контролируемых параметров

Буй измеряет девять величин: водородный показатель (pH), температуру, растворённый
кислород, мутность, удельную электропроводность, общую минерализацию,
окислительно-восстановительный потенциал, суммарное содержание углеводородов и заряд
батареи. Состав определён тремя ограничениями.

**Возможность непрерывного измерения непосредственно в воде.** Большинство из 37
показателей государственного мониторинга — тяжёлые металлы, пестициды и подобные им —
определяются лабораторными методами и требуют доставки пробы в лабораторию;
автоматизировать их на автономном буе невозможно. Выбранные девять измеряются погружными
датчиками прямо в акватории, без реагентов и пробоподготовки. Пять из них — температура,
водородный показатель, растворённый кислород, взвешенные вещества (мутность) и
нефтепродукты (суммарные углеводороды) — входят в перечень показателей государственного
мониторинга, поэтому ряды наблюдений сопоставимы с официальными данными.

**Энергетический бюджет и ёмкость радиоканала.** Буй питается от аккумулятора и солнечной
панели, а кадр LoRaWAN ограничен по размеру — телеметрия упакована в 18 байт. Каждый
дополнительный параметр увеличивает потребление датчиков и длину кадра, сокращая
автономность узла.

**Взаимная перепроверка при аварии.** Параметры подобраны так, чтобы нефтяной разлив давал
отклик сразу по четырём независимым признакам: рост суммарных углеводородов, рост мутности,
падение растворённого кислорода и снижение водородного показателя. Совпадение нескольких
признаков подтверждает событие и снижает вероятность ложной тревоги из-за отказа одиночного
датчика.

| Параметр | Что показывает |
|---|---|
| Суммарные углеводороды | Прямой индикатор нефтяного загрязнения. Порог 0,05 мг/л — ПДК для водных объектов рыбохозяйственного значения |
| Растворённый кислород | Состояние экосистемы: падение ниже 6,0 мг/л — угроза замора рыбы, ниже 4,0 мг/л — критическое состояние |
| Мутность | Взвешенные вещества: рост при разливах, дноуглублении, штормовом взмучивании |
| Водородный показатель | Базовая характеристика воды; снижается при поступлении органических загрязнителей |
| Температура | Собственный показатель и величина, необходимая для расчёта насыщения воды кислородом |
| Удельная электропроводность | Измеряемая величина, из которой рассчитывается минерализация |
| Общая минерализация | Солёность — ключевой параметр на фоне падения уровня моря и осолонения мелководий |
| Окислительно-восстановительный потенциал | Окислительная способность воды; снижается при поступлении органики и нефтепродуктов |
| Заряд батареи | Служебный параметр: контроль работоспособности узла и планирование обслуживания |
