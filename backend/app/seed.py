...
DEVICES: list[dict] = [
    ...
    ("70b3d57ed0060001", "BY-01", "Актау — офшор юг", 43.74, 50.715, 8.12, 14.3, 7.8, 12.4, 24.6, 286, 0.04),
    ("70b3d57ed0060002", "BY-02", "Платформа CK-2", 44.547, 49.895, 7.62, 13.8, 4.2, 28.6, 24.1, 198, 0.38),
    ("70b3d57ed0060003", "BY-03", "Офшор Мангыстау", 44.613, 50.063, 8.24, 12.9, 8.6, 6.2, 25.1, 312, 0.02),
    ("70b3d57ed0060004", "BY-04", "Кашаган — зона А", 45.071, 51.037, 8.10, 13.0, 7.5, 10.0, 24.5, 280, 0.03),
    ("70b3d57ed0060005", "BY-05", "Актау — офшор север", 43.95, 50.9, 8.18, 13.1, 8.1, 9.5, 24.8, 299, 0.01),
    ("70b3d57ed0060006", "BY-06", "Глубоководный рубеж", 44.374, 49.803, 8.09, 14.7, 7.4, 7.8, 24.4, 278, 0.03),
    ("70b3d57ed0060007", "BY-07", "Каламкас — акватория", 44.939, 51.236, 7.71, 11.8, 5.1, 31.2, 23.9, 205, 0.12),
    ("70b3d57ed0060008", "BY-08", "Южный Каспий KZ", 43.309, 50.953, 8.21, 15.2, 8.9, 5.4, 25.3, 320, 0.01),
    ("70b3d57ed0060009", "BY-09", "Западный шельф", 44.829, 50.01, 8.15, 14.0, 7.6, 8.2, 24.9, 291, 0.03),
    ("70b3d57ed006000a", "BY-10", "Центральная банка", 44.75, 50.318, 8.07, 13.6, 7.2, 11.0, 24.5, 275, 0.04),
    ("70b3d57ed006000b", "BY-11", "Промысловый р-н №3", 44.764, 51.184, 7.89, 12.2, 6.1, 18.5, 24.2, 242, 0.07),
    ("70b3d57ed006000c", "BY-12", "Жетыбай — акватория", 43.603, 50.856, 8.22, 14.8, 8.3, 7.0, 25.0, 308, 0.02),
    ("70b3d57ed006000d", "BY-13", "Северный сектор KZ", 44.908, 50.565, 8.11, 11.4, 7.9, 9.8, 24.7, 284, 0.03),
    ("70b3d57ed006000e", "BY-14", "Дальний офшор", 43.906, 50.751, 8.19, 15.5, 8.5, 4.8, 25.2, 315, 0.01),
    ("70b3d57ed006000f", "BY-15", "Шельф Дунга", 43.469, 50.85, 8.28, 11.9, 9.1, 5.2, 25.4, 328, 0.01),
    ("70b3d57ed0060010", "BY-16", "Северная банка Кашаган", 45.083, 50.718, 8.14, 12.5, 7.7, 8.9, 24.8, 290, 0.02),
]
